...
(function (exports, Laya) {
    ...
    class RigidBody extends Laya.Component {
        ...
        _createBody() {
            ...
            var point = sp.posGlob(Laya.Point.TEMP.setTo(0, 0), false, IPhysics.Physics.I.worldRoot);
        ...
        _sysNodeToPhysic() {
            ...
            var p = sp.posGlob(Laya.Point.TEMP.setTo(0, 0), false, IPhysics.Physics.I.worldRoot);
    ...
    class Physics extends Laya.EventDispatcher {
        ...
        set worldRoot(value) {
            ...
            if (value) {
                var p = value.posGlob(Laya.Point.TEMP.setTo(0, 0));
                this.world.ShiftOrigin({ x: -p.x / Physics.PIXEL_RATIO, y: -p.y / Physics.PIXEL_RATIO });
            }
        }
        updatePhysicsByWorldRoot() {
            if (!!this.worldRoot) {
                var p = this.worldRoot.posGlob(Laya.Point.TEMP.setTo(0, 0));
                this.world.ShiftOrigin({ x: -p.x / Physics.PIXEL_RATIO, y: -p.y / Physics.PIXEL_RATIO });
            }
        }
    }
    ...
    class MouseJoint extends JointBase {
        ...
        _createJoint() {
            if (!this._joint) {
                ...
                if (this.anchor) {
                    var anchorPos = this.selfBody.owner.posGlob(Laya.Point.TEMP.setTo(this.anchor[0], this.anchor[1]), false, Physics.I.worldRoot);
                }
                else {
    ...
    class PulleyJoint extends JointBase {
        ...
        _createJoint() {
            if (!this._joint) {
                ...
                var posA = this.otherBody.owner.posGlob(Laya.Point.TEMP.setTo(this.otherAnchor[0], this.otherAnchor[1]), false, Physics.I.worldRoot);
                var anchorVecA = new box2d.b2Vec2(posA.x / Physics.PIXEL_RATIO, posA.y / Physics.PIXEL_RATIO);
                var posB = this.selfBody.owner.posGlob(Laya.Point.TEMP.setTo(this.selfAnchor[0], this.selfAnchor[1]), false, Physics.I.worldRoot);
                var anchorVecB = new box2d.b2Vec2(posB.x / Physics.PIXEL_RATIO, posB.y / Physics.PIXEL_RATIO);
                var groundA = this.otherBody.owner.posGlob(Laya.Point.TEMP.setTo(this.otherGroundPoint[0], this.otherGroundPoint[1]), false, Physics.I.worldRoot);
                var groundVecA = new box2d.b2Vec2(groundA.x / Physics.PIXEL_RATIO, groundA.y / Physics.PIXEL_RATIO);
                var groundB = this.selfBody.owner.posGlob(Laya.Point.TEMP.setTo(this.selfGroundPoint[0], this.selfGroundPoint[1]), false, Physics.I.worldRoot);
